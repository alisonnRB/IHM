...
export default {
  ...
  enviar: async (id_ref, chave) => {
    ...
    const response = await fetch('http://192.168.255.193/server/votar.php', requisição);
    const resposta = await fetch('http://192.168.255.193/server/contaVotos.php', requisição);
