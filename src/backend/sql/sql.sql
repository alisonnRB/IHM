...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21/08/2023 às 22:52
...
-- Banco de dados: `ihm`
--
CREATE DATABASE IF NOT EXISTS `ihm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ihm`;
...
INSERT INTO `livro_publi` (`id`, `user_id`, `nome`, `imagem`, `data`, `genero`) VALUES
(2, 1, 'manifesto', 'vhfrysmthsmyhjtyhmhm ', '2023-07-20', 'romance');
...
(1, 'bruno', 'alisonkpops@gmail.com', 'minhasenha833', '1_1692485185.jpg', '[\"1\",\"2\",\"5\",\"9\",\"10\",\"11\",\"12\"]'),
...
('root', '[{\"db\":\"ihm\",\"table\":\"usuarios\"},{\"db\":\"ihm\",\"table\":\"genero\"}]');
...
('root', '2023-08-21 20:52:24', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt_BR\"}');
